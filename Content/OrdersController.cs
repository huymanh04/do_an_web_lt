...
namespace do_an_web.Content
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "order_id,account_id,order_date,total_amount,status")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "order_id,account_id,order_date,total_amount,status")] Order order)
        {
            if (ModelState.IsValid)
            {
